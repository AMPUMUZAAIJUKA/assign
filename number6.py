...
if bfs_path is not None:
    print("BredthFirstSearch Path:", bfs_path)
else:
...
if dfs_path is not None:
    print("DepthFirstSerach Path:", dfs_path)
else:
    print("DFS did not find a path.")
print("DFS Expanded States:", dfs_expanded)
print("DepthFirstSerach Unexpanded States:", dfs_unexpanded)

# Uniform Cost Search
ucs_path, ucs_expanded, ucs_unexpanded = ucs(weighted_graph, start_node, goal_node)
if ucs_path is not None:
    print("UniformCostSearch Path:", ucs_path)
else:
    print("UCS did not find a path.")
print("UniformCostSearch Expanded States:", ucs_expanded)
print("UniformCostSearch Unexpanded States:", ucs_unexpanded)
...
if astar_path is not None:
    ...
    print("A* Search Expanded nodes:", astar_expanded)
else:
